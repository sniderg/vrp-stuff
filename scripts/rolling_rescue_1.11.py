...
def main():
    instance = load_instance("roadef_2016_data/set_A_v1_1/Instances V1.1/Instance_V_1.11.xml")
    solution = load_solution("roadef_2016_data/hust_smart_results/v1_1.11_temp_0.10.xml")
    
    # 5-day rolling windows with 1-day overlap starting from Day 18
    windows = [
        (18, 23, 18),
        (22, 27, 22),
        (26, 31, 26),
    ...
    for i, (start_day, end_day, replace_from_day) in enumerate(windows):
        ...
        if not optimal_found:
            print("Warning: Could not find an optimal quantity repair for this window.")
    ...
    save_solution(solution, "roadef_2016_data/hust_smart_results/v1_1.11_rescued.xml")
    print("Saved final rescued solution to roadef_2016_data/hust_smart_results/v1_1.11_rescued.xml")
